...
커피타임의 목적은 원격으로 업무가 이뤄지는 과정에서도 서로간의 인간적인 교류까지 단절되는것은 바람직하지 않기 때문이다. 우리는 매주 1:1로 짝을 만들어, 매주 월요일에 #notice 채널에 공지한다. 매칭된 사람은 해당 주간에 커피 한잔을 들고 적어도 30분 이상 화상대화(오프라인대화)를 하고, 이 결과를 --에 기록해야 한다. 기록의 내용은 다음과 같다.
