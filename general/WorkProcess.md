...
4. 월간 계획을 바탕으로 주간 목표의 우선순위를 수정할 수 있다.
   * 차주 미팅/세미나/데모 : [협동](https://github.com/Onther-Tech/handbook/blob/master/general/GENERAL.md#%ED%98%91%EB%8F%99)과 [성장](https://github.com/Onther-Tech/handbook/blob/master/general/GENERAL.md#%EC%84%B1%EC%9E%A5)을 위해 차주의 할 일과 연관되어 진행할 [데모](#데모)/[세미나](#세미나), 혹은 정해진 미팅을 적는다. 이후에 직접 [캘린더](#온더-캘린더)에 반영한다.
...
2. 일정 추가 : "온더" [온더 캘린더](#온더-캘린더)에 일정을 추가한다.
