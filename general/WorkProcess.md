...
4. 어떤 문제가 충분히 많은 사람들에게 알려져야 하고, 추적 및 관리해야 된다면 채팅이 아니라 일감(issue)을 만들어라. [트렐로]() 가이드라인 참조.
...
5. 월간 계획을 바탕으로 주간 목표의 우선순위를 수정할 수 있다.
   * 차주 미팅or세미나or데모 : [협동](#협동)과 [성장](#성장)을 위해 차주의 할 일과 연관되어 진행할 [데모](#데모)([세미나](#세미나)), 혹은 정해진 미팅을 적는다. 이후에 직접 [캘린더](#구글 캘린더)에 반영한다.
...
### 구글 캘린더
  ...
  6. 세미나 일정 생성시, 캘린더 제목추가 규칙, 링크생성 방식, 발표자료 공유 방식을 준수한다. [세미나 개설 방법](#세미나-개설-방법)
