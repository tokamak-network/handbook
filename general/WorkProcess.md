...
## 도구
명심할 점은 목적에 집중하되, 수단에 매몰되지 않도록 한다. 프로세스는 프로세스일 뿐, 목적은 결국 서로가 믿고 업무할 수 있는 효율적이고 투명하고 공개적인 의사소통을 할 수 있는 수단을 마련하는 것이다. 수단의 원칙으로는 하나의 도구로 여러가지의 일을 할 수 있다면 되도록 도구는 통합한다. 이와 관련된 아이디어가 필요한데, 누구나 의견을 제시할 수 있다.
